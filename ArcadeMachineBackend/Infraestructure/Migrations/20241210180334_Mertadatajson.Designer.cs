...
namespace ArcadeMachine.Infraestructure.Migrations
{
    ...
    [Migration("20241210180334_Mertadatajson")]
    partial class Mertadatajson
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArcadeMachine.Domain.Entities.MiniJuego", b =>
                {
                    b.OwnsOne("ArcadeMachine.Domain.Entities.Metadata", "Metadata", b1 =>
                        {
                            b1.Property<Guid>("MiniJuegoId")
                                .HasColumnType("uuid");

                            b1.Property<bool>("Ia")
                                .HasColumnType("boolean");

                            b1.HasKey("MiniJuegoId");

                            b1.ToTable("minijuegos");

                            b1.ToJson("Metadata");

                            b1.WithOwner()
                                .HasForeignKey("MiniJuegoId");
                        });
